...
- Should be used instead of useState for more complex state
- useReducer can be used instead of Redux if the state is only needed in one component
...
### Example of using useReducer on array inside an object
...
## useContext
- Passes data down to different components similarly to Redux store
